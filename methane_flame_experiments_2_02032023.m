...
% tif image batch
if X == 0
    path = "/Volumes/TOSHIBA EXT/CambridgeExperiments/H2 project/experiments/02_03_2023_Zyla5p5/rolling shutter/air_310mJ.tif";
else
    path = "/Volumes/TOSHIBA EXT/CambridgeExperiments/H2 project/experiments/02_03_2023_Zyla5p5/rolling shutter/air_310mJ_X"+string(X)+".tif";
end
N = length(imfinfo(path));
...
% tif image batch
if X == 0
    path = "/Volumes/TOSHIBA EXT/CambridgeExperiments/H2 project/experiments/02_03_2023_Zyla5p5/rolling shutter/chem_1mJ.tif";
else
    path = "/Volumes/TOSHIBA EXT/CambridgeExperiments/H2 project/experiments/02_03_2023_Zyla5p5/rolling shutter/chem_1mJ_X"+string(X)+".tif";
end
N = length(imfinfo(path));
